...
from .views import UserHome,Profile,BioView,EditView,ChangePasswordView,MyPostView,PostEditView,PostDeleteView,Addcomment,addlike
...
urlpatterns=[
    ...
    path("like/<int:pid>",addlike,name="like"),
]